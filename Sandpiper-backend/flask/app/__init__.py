...
api = Api(
    ...
    description="Welcome to the API documentation of Sandpiper API",
...
def create_app():
    ...
    # Configure Flask to handle trailing slashes more gracefully
    ...
    @app.route('/')
    def hello_world():
        return 'Welcome to Sandpiper API.'
